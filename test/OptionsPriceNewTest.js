let OptionsPriceNew = artifacts.require("OptionsPriceNew");
...
contract('OptionsPriceNew', function (accounts){
    // it('OptionsPrice Call options', async function (){
    //     let priceInstance = await OptionsPriceNew.new();
    ...
    it('OptionsPrice Call options', async function (){
        ...
        let priceInstance = await OptionsPriceNew.new(volInstance.address);
