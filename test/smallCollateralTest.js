...
//        return;
        ...
        await OptionsManger.addCollateral(collateral0,1,{value : 1});
        ...
        await OptionsManger.addCollateral(collateral0,1,{from : accounts[1],value : 1});
        ...
        await logBalance(fnx,collateralInstance.address);
        await fnx.approve(OptionsManger.address,1);
        await OptionsManger.addCollateral(fnx.address,1);
        await logBalance(fnx,collateralInstance.address);
...
*/
        ...
        await logBalance(fnx,collateralInstance.address);
        await OptionsManger.redeemCollateral(1,fnx.address,{from:accounts[1]});
        await logBalance(fnx,collateralInstance.address);
