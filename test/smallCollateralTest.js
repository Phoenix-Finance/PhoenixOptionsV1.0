...
//        return;
        ...
        let smallAmount = 1000000000;
        await contracts.manager.addCollateral(collateral0,smallAmount,{value : smallAmount});
        ...
        await contracts.manager.addCollateral(collateral0,smallAmount,{from : accounts[1],value : smallAmount});
        ...
        await logBalance(contracts.FNX,contracts.collateral.address);
        await contracts.FNX.approve(contracts.manager.address,smallAmount);
        await contracts.manager.addCollateral(contracts.FNX.address,smallAmount);
        await logBalance(contracts.FNX,contracts.collateral.address);
...
*/
        ...
        await logBalance(contracts.FNX,contracts.collateral.address);
        await contracts.manager.redeemCollateral(smallAmount,collateral0);
        await logBalance(contracts.FNX,contracts.collateral.address);
        result = await contracts.options.getTotalOccupiedCollateral();
        console.log(result.toString(10));
        result = await contracts.manager.getTotalCollateral();
        ...
        await contracts.manager.redeemCollateral(smallAmount,contracts.FNX.address);
        await logBalance(contracts.FNX,contracts.collateral.address);
        await contracts.manager.redeemCollateral(smallAmount,contracts.FNX.address,{from:accounts[1]});
        await logBalance(contracts.FNX,contracts.collateral.address);
//        await contracts.manager.redeemCollateral(smallAmount,contracts.FNX.address,{from:accounts[2]});
//        await logBalance(contracts.FNX,contracts.collateral.address);
        result = await contracts.options.getTotalOccupiedCollateral();
        console.log(result.toString(10));
        result = await contracts.manager.getTotalCollateral();
